describe("PastJobsCtrl", function () {
  ...
  describe("self.retrieveJobs", function () {
    describe("when taskerService.getPastJobs succeeds", function () {
      it("stores the response jobs in self.jobs", inject(function ($q) {
        ...
        spyOn(taskerServiceMock, "getPastJobs").and.returnValue(response.promise);
        self.retrieveJobs();
    ...
    describe("when taskerService.getPastJobs fails", function () {
